...
This is just a short example from the full module that we have translated. For more code you can look at the Attachments section.
...
=======
>>>>>>> d9b4f62388a7dd836c0dce4e62810b2574066468
...
To be a company that is trying new untested new technology can be a high risk high reward scenario. Often when we are talking about new technology in software we are talking about new programming languages. Even though F\# is a relativity new programming language it have been tried out with success multiple of times.\\
