...
\begin{tabular}{ |p{(\textwidth / 10)*7}|p{(\textwidth / 10)*3}|  }
 \hline
 \textbf{Study:} Automation&\textbf{Year:} 2016\\
 \hline
\end{tabular}\\
...
\begin{tabular}{ |p{(\textwidth / 10)*7}|p{(\textwidth / 10)*3}|  }
 	...
 	\vspace{1mm}
 	\textbf{Title:}\\
 	The analysis of C\# to F\#\vspace{5mm}
 	
 	\textbf{Authors:}
 	\begin{itemize}
 		\item Jostein Andreassen
 		\item Michael Blomli
 		\item Mikkel Eltervåg
 	\end{itemize}
