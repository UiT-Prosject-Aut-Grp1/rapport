...
This is just a short example from the full module that we have translated. For more code you can look at the Appendices section.
...
\begin{figure}[!h]
    ...
    \centering
    \caption{Picture showing table name from database when using the "dot" in tool with F\# with the data provider.}
    \label{fig:DotInTool}
\end{figure}
...
Learning a new programming language can take a lot of time from where the programmers could be making applications that generate income. This is especially true when it comes to F\#. This is both because F\# have a less known syntax and that F\# is a functional programming language.\\
