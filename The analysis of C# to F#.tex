...
\subsection{Solution}
There are two ways of translating code, the first one is to directly translate the program and the other is to translate it how it should be written in the new language. Here we look at both, the direct translation and the more functional approach and consider pros and cons of the methods.
...
The direct translation is maybe the most easy and the fastest method to translate the program. But it might have more flaws and result in worse performance to use this approach. Below examples are presented that show the direct translation.
...
The functional approach is the more proper way to do it but it can take longer time and be harder to do if the person is not fluent in the new language. The benefits can be better performance, less bugs and more readable code. Below examples are presented that show the functional approach.
...
\newpage
\subsection{A closer look at our code}
